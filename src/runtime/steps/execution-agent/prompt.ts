...
export function buildExecutionAgentInstructions(params: {
  ...
  return [
    ...
    "When runtime_execution_state_v1 contains capabilitySelectionReconsideration, it passively records that the listed selection was reconsidered before execution. It is not a capability result and chooses no replacement; decide the next action yourself.",
